...
<header>
  <b-navbar toggleable fixed="top" type="inverse" style="background-color: #5893ff;box-shadow: 0 1px 3px #4277d8;">
    <div class="container">
      ...
      <b-link class="navbar-brand" to="/" target="_blank">
        <span>BG-Process</span>
      </b-link>
      ...
      <b-collapse is-nav id="nav_collapse">
        ...
        <b-nav is-nav-bar class="ml-auto" v-show="projInfo">
          <b-nav-item :href="projInfo.github" target="_blank"><i class="icon-github-circled"></i>Esoftplay</b-nav-item>
        </b-nav>
      </b-collapse>
    </div>
  </b-navbar>
