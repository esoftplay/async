...
namespace esoftplay\gearman\tools;

use esoftplay\gearman\Helper;
use esoftplay\gearman\BaseManager;

/**
 * Class WebPanelHandler
 * @package esoftplay\gearman\tools
 */
class WebPanelHandler
{
    /**
...
/////////////////////////////////////////////////////////////////////
    ...
    public function projInfoAction()
    {
        $this->outJson([
            ...
            'github' => 'http://github.com/esoftplay/async',
            'gitosc' => 'http://git.fisip.net',
        ]);
    }
